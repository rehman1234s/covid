...
<html>
   			...
   			try
   			{
   				...
   				String name = request.getParameter("name");
   	   			...
   	   			String covidstatus = request.getParameter("covidstatus");
   	   			 ...
   	   			 String query = "update status set name = ?, address= ?, batch =? ,covidstatus= ? where regno = ?";
	...
	<h4 style="color:<%= color %>"><%= msg %></h4>
        ...
        <form id="form" method="post" action="editCase.jsp" class="form-horizontal">
             ...
             <% 
                           ...
                           String id = request.getParameter("id");
                            ...
                            pst = con.prepareStatement("select * from status where regno = ?");
                            pst.setString(1, id);
                            rs = pst.executeQuery();
			...
			<div class="form-group">
                 <div  class="col-sm-4"></div>
                  <div  class="col-sm-4 mx-auto">
                  	<label>Course:</label>
  					<input type="text" name="batch" class="form-control" id="batch" value="<%= rs.getString("batch") %>">
                  </div>
			</div>
			<div class="form-group">
                            <div  class="col-sm-4"></div>
			...
			<div class="form-group">
                            ...
                            <div  class="col-sm-4 mx-auto">
                                    <label>Phone</label>
  				    <input type="text" name="covidstatus" class="form-control" id="covidstatus" value="<%= rs.getString("covidstatus") %>">
                            </div>
			</div>
